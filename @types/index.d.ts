export declare global {
  ...
  class _DOMNodeReference {
    ...
    /**
     * The checked prop that will be available on instances of
     * this class that are radio inputs
     * @type {boolean}
     */
    checked: boolean;
    ...
    configureValidationAndRequirements(
      config: {
        requirementLogic: (this: DOMNodeReference) => boolean;
        validationLogic: (this: DOMNodeReference) => boolean;
      },
